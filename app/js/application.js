...
const applicationTableFilter = document.querySelector('.application__table._filter-profile tbody');
...
function getApplicationsFilter() {
    ...
    //let applicationItem = applicationTableFilter.querySelectorAll('.application__item');
    ...
    getApplications(applicationTableFilter, null);
}
