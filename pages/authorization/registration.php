...
<main class="main">
    <div class="container">
        ...
        <?= renderNavigationTop() ?>
            ...
            <form class="registration block-default" method="POST" enctype="multipart/form-data">
                ...
                <div class="registration__grid">
                    <div class="registration__textarea-form textarea-form">
                        ...
                        <textarea class="registration__textarea textarea" placeholder="Начните вводить текст" id="user_about" name="user_about"></textarea>
                    </div>
                    <div class="registration__input-form input-form">
                ...
                <div class="registration__input-form_file input-form">
                    ...
                    <label class="registration__input-file input-file" for="file">
                        ...
                        <span class="button-dark input-file__button">
