        ...
        <main class="main">
            <div class="container">
                <div class="registration__main">
                    <a class="registration__link-back link" href="">
                        Назад
                    </a>
                    ...
                    <form class="registration__form">
                        <div class="registration__form_top">
                            ...
                            <div class="input__block">
                                ...
                                <div class="input-password block__password">
                                    <input class="input" type="password" for="user_email">
                        ...
                        <div class="registration__form_bottom">
                            <div class="input__block">
                                ...
                                <input class="input" type="text" id="user_name">
                            </div>
                            <div class="input__block">
                                <label class="input__title" for="user_surname">
                                    Фамилия
                                </label>
                                <input class="input" type="text" id="user_surname">
                            </div>
                        </div>
                        <a class="registration__button button" href="/pages/registration-confrim.html">
                            Продолжить
                        </a>
                    </form>
                </div>
