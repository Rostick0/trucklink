                ...
                <div class="applicaton-create__main">
                    ...
                    <form class="applicaton-create__form" method="POST">
                        <div class="input__block">
                            ...
                            <input class="input" type="text" value="<?= $_SESSION['user']['name'] . " " . $_SESSION['user']['surname'] ?>" id="user_fullname" placeholder="Сергей Иванов">
                        </div>
                        <div class="input__block">
                            <label class="input__title" for="user_phone">
                                Номер телефона:
                            </label>
                            <input class="input input-tel" type="tel" value="<?= $_SESSION['user']['telephone'] ?>" id="user_phone" placeholder="+1(ххх)ххх-хх-хх">
                        </div>
                        <div class="input__block">
                            <label class="input__title" for="user_email">
                                E-mail:
                            </label>
                            <input class="input" type="email" value="<?= $_SESSION['user']['email'] ?>" id="user_email" placeholder="info@trucklink.com">
                        </div>
