<form class="catalog__filter filter block-default" method="POST">
            ...
            <div class="filter__small-inputs">
                <div class="calendar-form">
                    <div class="calendar-from__active">
                        <input type="text" class="input date_start__input" placeholder="Дата от:" id="date_start" name="date_start" readonly>
    ...
    <div class="filter__min-max">
        <div class="filter__price">
            <div class="filter__input-form input-form">
                <label class="label__for-input" for="price_min">
                    Цена <sup>&#8381;</sup>
                </label>
                <div class="filter__small-inputs">
                    <input type="number" class="input" placeholder="от" name="price_min" id="price_min">
        ...
        <div class="filter__volume">
            <div class="filter__input-form input-form">
                <label class="label__for-input" for="volume_min">
                    Объём <sup>м3</sup>
                </label>
                <div class="filter__small-inputs">
                    <input type="number" class="input" placeholder="от" name="volume_min" id="volume_min">
        ...
        <div class="filter__mass">
            <div class="filter_input-form input-form">
                <label class="label__for-input" for="mass_min">
                    Масса <sup>т</sup>
                </label>
                <div class="filter__small-inputs">
                    <input type="number" class="input" placeholder="от" name="mass_min" id="mass_min">
